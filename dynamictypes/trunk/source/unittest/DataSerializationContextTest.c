...
#define verifyFunctionPointers(context) \
	...
	verifyFunctionPointer(context, writeFixed16_16); \
...
#define FORMAT_DATA_TYPE_FIXED_16_16 "0x%05X"
...
static void testValuesInArray() {
	...
	context->writeFixed16_16(context, NULL, 0x00000);
	context->writeFixed16_16(context, NULL, 0x10000);
	...
	TestCase_assert(result->value.array->count == 38, "Expected 38 but got " SIZE_T_FORMAT, result->value.array->count);
	...
	assertDataValueInArray(result->value, 18, DATA_TYPE_FLOAT, 0.0f, float32);
	assertDataValueInArray(result->value, 19, DATA_TYPE_FLOAT, 1.0f, float32);
	assertDataValueInArray(result->value, 20, DATA_TYPE_DOUBLE, 0.0, float64);
	assertDataValueInArray(result->value, 21, DATA_TYPE_DOUBLE, 1.0, float64);
	assertDataValueInArray(result->value, 22, DATA_TYPE_FIXED_16_16, 0x00000, fixed);
	assertDataValueInArray(result->value, 23, DATA_TYPE_FIXED_16_16, 0x10000, fixed);
	assertDataValueInArray(result->value, 24, DATA_TYPE_INT32, ENUM_TEST_0, int32);
	assertDataValueInArray(result->value, 25, DATA_TYPE_INT32, ENUM_TEST_1, int32);
	assertDataValueInArray(result->value, 26, DATA_TYPE_UINT8, 0xAA, uint8);
	assertDataValueInArray(result->value, 27, DATA_TYPE_UINT8, 0x57, uint8);
	assertDataValueInArray(result->value, 28, DATA_TYPE_UINT16, 0xF001, uint16);
	assertDataValueInArray(result->value, 29, DATA_TYPE_UINT16, 0x000F, uint16);
	assertDataValueInArray(result->value, 30, DATA_TYPE_UINT32, 0xF0000001, uint32);
	assertDataValueInArray(result->value, 31, DATA_TYPE_UINT32, 0x0000001E, uint32);
	assertDataValueInArray(result->value, 32, DATA_TYPE_UINT64, 0xF000000000000001ull, uint64);
	assertDataValueInArray(result->value, 33, DATA_TYPE_UINT64, 0x000000000000003Cull, uint64);
	assertStringInArray(result->value, 34, "foo");
	assertStringInArray(result->value, 35, "bar");
	assertBlobInArray(result->value, 36, "a", 1);
	assertBlobInArray(result->value, 37, "abcd", 4);
...
static void testValuesInHashTable() {
	...
	context->writeFixed16_16(context, "fixed_0", 0x00000);
	context->writeFixed16_16(context, "fixed_1", 0x10000);
	...
	TestCase_assert(result->value.hashTable->count == 38, "Expected 38 but got " SIZE_T_FORMAT, result->value.hashTable->count);
	...
	assertDataValueInHashTable(result->value, "float_0", DATA_TYPE_FLOAT, 0.0f, float32);
	assertDataValueInHashTable(result->value, "float_1", DATA_TYPE_FLOAT, 1.0f, float32);
	assertDataValueInHashTable(result->value, "double_0", DATA_TYPE_DOUBLE, 0.0, float64);
	assertDataValueInHashTable(result->value, "double_1", DATA_TYPE_DOUBLE, 1.0, float64);
	assertDataValueInHashTable(result->value, "fixed_0", DATA_TYPE_FIXED_16_16, 0x00000, fixed);
	assertDataValueInHashTable(result->value, "fixed_1", DATA_TYPE_FIXED_16_16, 0x10000, fixed);
...
static void testValuesInAssociativeArray() {
	...
	TestCase_assert(result->value.associativeArray->count == 38, "Expected 38 but got " SIZE_T_FORMAT, result->value.associativeArray->count);
	...
	assertDataValueInAssociativeArray(result->value, 18, "float_0", DATA_TYPE_FLOAT, 0.0f, float32);
	assertDataValueInAssociativeArray(result->value, 19, "float_1", DATA_TYPE_FLOAT, 1.0f, float32);
	assertDataValueInAssociativeArray(result->value, 20, "double_0", DATA_TYPE_DOUBLE, 0.0, float64);
	assertDataValueInAssociativeArray(result->value, 21, "double_1", DATA_TYPE_DOUBLE, 1.0, float64);
	assertDataValueInAssociativeArray(result->value, 22, "fixed_0", DATA_TYPE_FIXED_16_16, 0x00000, fixed);
	assertDataValueInAssociativeArray(result->value, 23, "fixed_1", DATA_TYPE_FIXED_16_16, 0x10000, fixed);
	assertDataValueInAssociativeArray(result->value, 24, "enum_0", DATA_TYPE_INT32, ENUM_TEST_0, int32);
	assertDataValueInAssociativeArray(result->value, 25, "enum_1", DATA_TYPE_INT32, ENUM_TEST_1, int32);
	assertDataValueInAssociativeArray(result->value, 26, "bitfield8_0", DATA_TYPE_UINT8, 0xAA, uint8);
	assertDataValueInAssociativeArray(result->value, 27, "bitfield8_1", DATA_TYPE_UINT8, 0x57, uint8);
	assertDataValueInAssociativeArray(result->value, 28, "bitfield16_0", DATA_TYPE_UINT16, 0xF001, uint16);
	assertDataValueInAssociativeArray(result->value, 29, "bitfield16_1", DATA_TYPE_UINT16, 0x000F, uint16);
	assertDataValueInAssociativeArray(result->value, 30, "bitfield32_0", DATA_TYPE_UINT32, 0xF0000001, uint32);
	assertDataValueInAssociativeArray(result->value, 31, "bitfield32_1", DATA_TYPE_UINT32, 0x0000001E, uint32);
	assertDataValueInAssociativeArray(result->value, 32, "bitfield64_0", DATA_TYPE_UINT64, 0xF000000000000001ull, uint64);
	assertDataValueInAssociativeArray(result->value, 33, "bitfield64_1", DATA_TYPE_UINT64, 0x000000000000003Cull, uint64);
	assertStringInAssociativeArray(result->value, 34, "string_0", "foo");
	assertStringInAssociativeArray(result->value, 35, "string_1", "bar");
	assertBlobInAssociativeArray(result->value, 36, "blob_0", "a", 1);
	assertBlobInAssociativeArray(result->value, 37, "blob_1", "abcd", 4);
...
#define testFailureWithAllTypes(ERROR_STATUS, PREAMBLE_CODE, KEY) \
	...
	testFailure(ERROR_STATUS, PREAMBLE_CODE, context->writeFixed16_16(context, KEY, 0x00000);); \
