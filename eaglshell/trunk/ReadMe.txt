EAGLShell is an implementation of a stem shell using EAGL, which builds for iPhone Simulator and iPhone OS (iPhone and iPad). It is a feature complete, production-ready shell.
