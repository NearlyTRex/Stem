...
static void testConversions() {
	...
	TestCase_assert(length == sizeof(stringUTF8) / sizeof(uint8_t) - 1, "Expected length to be %lu, but got %lu", sizeof(stringUTF8) / sizeof(uint8_t) - 1, (unsigned long) length);
	...
	TestCase_assert(length == sizeof(stringUTF16) / sizeof(uint16_t) - 1, "Expected length to be %lu, but got %lu", sizeof(stringUTF16) / sizeof(uint16_t) - 1, (unsigned long) length);
	...
	TestCase_assert(length == sizeof(stringUTF32) / sizeof(uint32_t) - 1, "Expected length to be %lu, but got %lu", sizeof(stringUTF32) / sizeof(uint32_t) - 1, (unsigned long) length);
