...
static void testConversions() {
	...
	TestCase_assert(length == sizeof(stringUTF8) / sizeof(uint8_t) - 1, "Expected length to be %d, but got %d", sizeof(stringUTF8) / sizeof(uint8_t) - 1, length);
	...
	TestCase_assert(length == sizeof(stringUTF16) / sizeof(uint16_t) - 1, "Expected length to be %d, but got %d", sizeof(stringUTF16) / sizeof(uint16_t) - 1, length);
	...
	TestCase_assert(length == sizeof(stringUTF32) / sizeof(uint32_t) - 1, "Expected length to be %d, but got %d", sizeof(stringUTF32) / sizeof(uint32_t) - 1, length);
...
static void testLength() {
	...
	TestCase_assert(length == sizeof(stringUTF8) / sizeof(uint8_t) - 1, "Expected length == %d, but got %d\n", sizeof(stringUTF8) / sizeof(uint8_t) - 1, length);
	length = utf16StringLength(stringUTF16);
	TestCase_assert(length == sizeof(stringUTF16) / sizeof(uint16_t) - 1, "Expected length == %d, but got %d\n", sizeof(stringUTF16) / sizeof(uint16_t) - 1, length);
	length = utf32StringLength(stringUTF32);
	TestCase_assert(length == sizeof(stringUTF32) / sizeof(uint32_t) - 1, "Expected length == %d, but got %d\n", sizeof(stringUTF32) / sizeof(uint32_t) - 1, length);
