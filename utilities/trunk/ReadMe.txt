Utilities contains miscellaneous convenience functions for working with files, strings, memory, and other things. The following sets of functionality are included:
 ...
 - HashTable: Arbitrary key-value association API, with convenience accessors for primitive types (functional but not optimized; may be slow and/or memory ineffiecient in this version)
