...
#define assertAllPointerTypesSeparate(expectedPointerValue, expectedStringValue, expectedBlobValue, expectedHashTableValue, expectedArrayValue) \
...
#define assertAllPointerTypes(expectedValue) \
	assertAllPointerTypesSeparate(expectedValue, expectedValue, expectedValue, expectedValue, expectedValue)
...
static void testConversions() {
	...
	getAllValues(value);
	assertAllPrimitiveTypes(false, 0, 0.0);
	assertAllPointerTypesSeparate((void *) 0x1, NULL, NULL, NULL, NULL);
	...
	getAllValues(value);
	assertAllPrimitiveTypes(false, 0, 0.0);
	assertAllPointerTypesSeparate(value.value.string.bytes, value.value.string.bytes, value.value.string.bytes, NULL, NULL);
	...
	getAllValues(value);
	assertAllPrimitiveTypes(false, 0, 0.0);
	assertAllPointerTypesSeparate(value.value.blob.bytes, NULL, value.value.blob.bytes, NULL, NULL);
	...
	getAllValues(value);
	assertAllPrimitiveTypes(false, 0, 0.0);
	assertAllPointerTypesSeparate(value.value.hashTable, NULL, NULL, value.value.hashTable, NULL);
	valueDispose(&value);
	...
	getAllValues(value);
	assertAllPrimitiveTypes(false, 0, 0.0);
	assertAllPointerTypesSeparate(value.value.array, NULL, NULL, NULL, value.value.array);
	valueDispose(&value);
}
