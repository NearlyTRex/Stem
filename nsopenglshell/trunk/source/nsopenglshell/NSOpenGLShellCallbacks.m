...
void (* mouseUpCallback)(unsigned int buttonNumber, float x, float y) __asm("mouseUpCallback$NSOpenGLShell");
void (* mouseMovedCallback)(float x, float y) __asm("mouseMovedCallback$NSOpenGLShell");
void (* mouseDraggedCallback)(unsigned int buttonMask, float x, float y) __asm("mouseDraggedCallback$NSOpenGLShell");
