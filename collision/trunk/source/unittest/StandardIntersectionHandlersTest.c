...
static void testCircle_circle() {
	...
	circle1 = CollisionCircle_create(NULL, NULL, VECTOR2x(-0x40000, 0x00000), 0x10000, false);
	circle2 = CollisionCircle_create(NULL, NULL, VECTOR2x(0x00000, 0x00000), 0x10000, false);
