...
static void verifyInit(int line, CollisionRect2D * rect, void * owner, CollisionCallback collisionCallback, Vector2x position, Vector2x size, fixed16_16 edgeThickness) {
	...
	TestCase_assert(rect->solidLeft, "Expected true but got false (line %d)", line);
	TestCase_assert(rect->solidRight, "Expected true but got false (line %d)", line);
	TestCase_assert(rect->solidBottom, "Expected true but got false (line %d)", line);
	TestCase_assert(rect->solidTop, "Expected true but got false (line %d)", line);
	TestCase_assert(rect->edgeThickness == edgeThickness, "Expected 0x%05X but got 0x%05X (line %d)", edgeThickness, rect->edgeThickness, line);
}
...
static void testInit() {
	...
	CollisionRect2D_init(&rect, NULL, NULL, VECTOR2x_ZERO, VECTOR2x_ZERO, 0x00000);
	verifyInit(__LINE__, &rect, NULL, NULL, VECTOR2x_ZERO, VECTOR2x_ZERO, 0x00000);
	...
	memset(&rect, 0x00, sizeof(rect));
	CollisionRect2D_init(&rect, (void *) 0x1234, (CollisionCallback) 0x2345, VECTOR2x(0x10000, 0x20000), VECTOR2x(0x30000, 0x40000), 0x08000);
	verifyInit(__LINE__, &rect, (void *) 0x1234, (CollisionCallback) 0x2345, VECTOR2x(0x10000, 0x20000), VECTOR2x(0x30000, 0x40000), 0x08000);
	CollisionRect2D_dispose(&rect);
	
	rectPtr = CollisionRect2D_create(NULL, NULL, VECTOR2x_ZERO, VECTOR2x_ZERO, 0x00000);
	verifyInit(__LINE__, rectPtr, NULL, NULL, VECTOR2x_ZERO, VECTOR2x_ZERO, 0x00000);
	CollisionRect2D_dispose(rectPtr);
	
	rectPtr = CollisionRect2D_create((void *) 0x1234, (CollisionCallback) 0x2345, VECTOR2x(0x10000, 0x20000), VECTOR2x(0x30000, 0x40000), 0x08000);
	verifyInit(__LINE__, rectPtr, (void *) 0x1234, (CollisionCallback) 0x2345, VECTOR2x(0x10000, 0x20000), VECTOR2x(0x30000, 0x40000), 0x08000);
	CollisionRect2D_dispose(rectPtr);
}
...
static void testUpdatePosition() {
	...
	rect = CollisionRect2D_create(NULL, NULL, VECTOR2x(0x10000, 0x20000), VECTOR2x_ZERO, 0x00000);
...
static void testUpdateSize() {
	...
	rect = CollisionRect2D_create(NULL, NULL, VECTOR2x_ZERO, VECTOR2x(0x10000, 0x20000), 0x00000);
...
static void testSetSolidity() {
	...
	rect = CollisionRect2D_create(NULL, NULL, VECTOR2x(0x00000, 0x00000), VECTOR2x(0x00000, 0x00000), 0x00000);
...
static void testIsStatic() {
	...
	rect = CollisionRect2D_create(NULL, NULL, VECTOR2x(0x00000, 0x00000), VECTOR2x(0x10000, 0x10000), 0x00000);
