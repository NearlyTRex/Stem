...
static void verifyStandardHandlers(int line, IntersectionManager * intersectionManager) {
	...
	verifyHandler(COLLISION_SHAPE_RECT, COLLISION_SHAPE_RECT, intersectionHandler_rect_rect)
	verifyHandler(COLLISION_SHAPE_RECT, COLLISION_SHAPE_CIRCLE, intersectionHandler_rect_circle)
	verifyHandler(COLLISION_SHAPE_RECT, COLLISION_SHAPE_LINE_2D, intersectionHandler_rect_line2D)
	verifyHandler(COLLISION_SHAPE_RECT, COLLISION_SHAPE_POLYGON, intersectionHandler_rect_polygon)
	...
	verifyHandler(COLLISION_SHAPE_BOX, COLLISION_SHAPE_BOX, intersectionHandler_box_box)
	verifyHandler(COLLISION_SHAPE_BOX, COLLISION_SHAPE_SPHERE, intersectionHandler_box_sphere)
	verifyHandler(COLLISION_SHAPE_BOX, COLLISION_SHAPE_LINE_3D, intersectionHandler_box_line3D)
	verifyHandler(COLLISION_SHAPE_BOX, COLLISION_SHAPE_CYLINDER, intersectionHandler_box_cylinder)
	verifyHandler(COLLISION_SHAPE_BOX, COLLISION_SHAPE_CAPSULE, intersectionHandler_box_capsule)
	verifyHandler(COLLISION_SHAPE_BOX, COLLISION_SHAPE_TRIMESH, intersectionHandler_box_trimesh)
	...
	verifyHandler(COLLISION_SHAPE_SPHERE, COLLISION_SHAPE_TRIMESH, intersectionHandler_sphere_trimesh)
	...
	verifyHandler(COLLISION_SHAPE_LINE_3D, COLLISION_SHAPE_TRIMESH, intersectionHandler_line3D_trimesh)
	...
	verifyHandler(COLLISION_SHAPE_CYLINDER, COLLISION_SHAPE_TRIMESH, intersectionHandler_cylinder_trimesh)
