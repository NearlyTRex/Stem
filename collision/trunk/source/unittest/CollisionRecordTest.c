...
static void testInverse() {
	...
	TestCase_assert(inverse.contactArea == 0, "Expected 0 but got %u", inverse.contactArea);
	...
	TestCase_assert(inverse.time == 2, "Expected 2 but got %u", inverse.time);
	TestCase_assert(inverse.contactArea == 10, "Expected 10 but got %u", inverse.contactArea);
...
static fixed16_16 lastSubframeTime1, lastSubframeTime2;

static void resolveCallback1(CollisionRecord collision, fixed16_16 timesliceSize, fixed16_16 subframeTime) {
	collisionCallback1Calls++;
	lastCollision1 = collision;
	lastTimesliceSize1 = timesliceSize;
	lastSubframeTime1 = subframeTime;
}

static void resolveCallback2(CollisionRecord collision, fixed16_16 timesliceSize, fixed16_16 subframeTime) {
	collisionCallback2Calls++;
	lastCollision2 = collision;
	lastTimesliceSize2 = timesliceSize;
	lastSubframeTime2 = subframeTime;
}
...
static void testResolve() {
	...
	collisionRecord.contactArea = 0x10000;
	...
	CollisionRecord_resolve(collisionRecord, 0x10000, 0x00000);
	...
	TestCase_assert(lastCollision1.time == 0x10000, "Expected 0x10000 but got 0x%05X", lastCollision1.time);
	TestCase_assert(lastCollision1.contactArea == 0x10000, "Expected 0x10000 but got 0x%05X", lastCollision1.contactArea);
	...
	TestCase_assert(lastSubframeTime1 == 0x00000, "Expected 0x00000 but got 0x%05X", lastSubframeTime1);
	...
	TestCase_assert(lastCollision2.time == 0x10000, "Expected 0x10000 but got 0x%05X", lastCollision1.time);
	TestCase_assert(lastCollision2.contactArea == 0x10000, "Expected 0x10000 but got 0x%05X", lastCollision1.contactArea);
	...
	TestCase_assert(lastSubframeTime2 == 0x00000, "Expected 0x00000 but got 0x%05X", lastSubframeTime2);
	...
	collisionRecord.contactArea = 0x04000;
	...
	CollisionRecord_resolve(collisionRecord, 0x06000, 0x04000);
	...
	TestCase_assert(lastCollision1.time == 0x08000, "Expected 0x08000 but got 0x%05X", lastCollision1.time);
	TestCase_assert(lastCollision1.contactArea == 0x04000, "Expected 0x04000 but got 0x%05X", lastCollision1.contactArea);
	...
	TestCase_assert(lastSubframeTime1 == 0x04000, "Expected 0x04000 but got 0x%05X", lastSubframeTime1);
	...
	TestCase_assert(lastCollision2.time == 0x08000, "Expected 0x08000 but got 0x%05X", lastCollision1.time);
	TestCase_assert(lastCollision2.contactArea == 0x04000, "Expected 0x04000 but got 0x%05X", lastCollision1.contactArea);
	...
	TestCase_assert(lastSubframeTime2 == 0x04000, "Expected 0x04000 but got 0x%05X", lastSubframeTime2);
