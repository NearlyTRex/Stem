...
static void testInit() {
	...
	context = interpolationContextInit(1.0f, 2.0f, 3.0, false, InterpolationCurveFunc_linear);
	...
	context = interpolationContextInit(2.0f, 1.0f, 5.0, true, InterpolationCurveFunc_easeInSin);
...
static void testAdvance() {
	...
	context = interpolationContextInit(2.0f, 4.0f, 8.0, false, InterpolationCurveFunc_linear);
...
static void testSetCurrentTime() {
	...
	context = interpolationContextInit(1.0f, 3.0f, 2.0, false, InterpolationCurveFunc_linear);
...
static void testSetProgress() {
	...
	context = interpolationContextInit(2.0f, 0.0f, 1.0, false, InterpolationCurveFunc_linear);
...
static void testClamping() {
	...
	context = interpolationContextInit(3.0f, 1.0f, 1.5, false, InterpolationCurveFunc_linear);
...
static void testExtrapolation() {
	...
	context = interpolationContextInit(3.0f, 1.0f, 1.5, true, InterpolationCurveFunc_linear);
	interpolationAdvance(&context, -1.5);
	TestCase_assert(context.currentProgress == -1.0, "Expected -1.0 but got %f", context.currentProgress);
...
static float curveFuncExtend(float value) {
	return -1.0f + value * 3.0f;
}

static float curveFuncReverse(float value) {
	return 1.0f - value;
}
...
static void testCurveFunc() {
	...
	context = interpolationContextInit(2.0f, 4.0f, 2.0, false, curveFuncExtend);
	...
	context = interpolationContextInit(2.0f, 4.0f, 2.0, false, curveFuncReverse);
