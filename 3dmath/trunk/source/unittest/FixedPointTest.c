...
static void testPow() {
	...
	TestCase_assert(result == 0x80000, "Expected 0x80000 but got 0x%X", result);
	result = fixed16_16_pow(0x18000, 0x18000);
	TestCase_assert(result == 0x1D64D, "Expected 0x1D64D but got 0x%X", result);
...
static void testSin() {
	...
	TestCase_assert(result == 0x0, "Expected 0x0 but got 0x%X", result);
	result = fixed16_16_sin(X_HALF_PI);
	TestCase_assert(result == 0x10000, "Expected 0x10000 but got 0x%X", result);
	result = fixed16_16_sin(X_PI);
	TestCase_assert(result == 0x0, "Expected 0x0 but got 0x%X", result);
	result = fixed16_16_sin(X_HALF_PI / 2);
	TestCase_assert(result == 0xB504, "Expected 0xB504 but got 0x%X", result);
	result = fixed16_16_sin(X_HALF_PI + X_HALF_PI / 2);
	TestCase_assert(result == 0xB504, "Expected 0xB504 but got 0x%X", result);
	result = fixed16_16_sin(X_PI + X_HALF_PI / 2);
	TestCase_assert(result == (fixed16_16) 0xFFFF4AFB, "Expected 0xFFFF4AFB but got 0x%X", result);
	result = fixed16_16_sin(X_PI + X_HALF_PI + X_HALF_PI / 2);
	TestCase_assert(result == (fixed16_16) 0xFFFF4AFB, "Expected 0xFFFF4AFB but got 0x%X", result);
	result = fixed16_16_sin(X_PI + X_HALF_PI);
	TestCase_assert(result == (fixed16_16) 0xFFFF0000, "Expected 0xFFFF0000 but got 0x%X", result);
	result = fixed16_16_sin(X_2_PI * 2);
	TestCase_assert(result == 0x0, "Expected 0x0 but got 0x%X", result);
	result = fixed16_16_sin(X_2_PI * -2);
	TestCase_assert(result == 0x0, "Expected 0x0 but got 0x%X", result);
#else
...
static void testCos() {
	...
	TestCase_assert(result == 0x10000, "Expected 0x10000 but got 0x%X", result);
	result = fixed16_16_cos(X_HALF_PI);
	TestCase_assert(result == 0x0, "Expected 0x0 but got 0x%X", result);
	result = fixed16_16_cos(X_PI);
	TestCase_assert(result == (fixed16_16) 0xFFFF0000, "Expected 0xFFFF0000 but got 0x%X", result);
	result = fixed16_16_cos(X_HALF_PI / 2);
	TestCase_assert(result == 0xB504, "Expected 0xB504 but got 0x%X", result);
	result = fixed16_16_cos(X_PI + X_HALF_PI);
	TestCase_assert(result == 0x0, "Expected 0x0 but got 0x%X", result);
	result = fixed16_16_cos(X_2_PI * 2);
	TestCase_assert(result == 0x10000, "Expected 0x10000 but got 0x%X", result);
	result = fixed16_16_cos(X_2_PI * -2);
	TestCase_assert(result == 0x10000, "Expected 0x10000 but got 0x%X", result);
#else
...
static void testTan() {
	...
	result = fixed16_16_tan(X_2_PI * 2);
	TestCase_assert(result == 0x0, "Expected 0x0 but got 0x%X", result);
	result = fixed16_16_tan(X_2_PI * -2);
	TestCase_assert(result == 0x0, "Expected 0x0 but got 0x%X", result);
#else
...
static void testAsin() {
	...
	TestCase_assert(result == X_HALF_PI, "Expected 0x%X but got 0x%X", X_HALF_PI, result);
	...
	TestCase_assert(result == X_HALF_PI / 2, "Expected 0x%X but got 0x%X", X_HALF_PI / 2, result);
