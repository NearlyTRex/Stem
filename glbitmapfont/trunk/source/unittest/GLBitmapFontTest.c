...
static void testIndexAtWidth() {
	...
	writeMeasurementTestChars1(characters);
	font = GLBitmapFont_create(characters);
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, -1.0f, 0.0f, NULL);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, -1.0f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 0.49f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 0.51f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 2.99f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 3.01f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 12.99f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 2, "Expected 2 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 13.01f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 2, "Expected 2 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 22.0f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 2, "Expected 2 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	
	charIndex = GLBitmapFont_indexAtPositionX(font, "ba", 2, 1.0f, 1.99f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "ba", 2, 1.0f, 2.01f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "ba", 2, 1.0f, 4.49f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "ba", 2, 1.0f, 4.51f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "ba", 2, 1.0f, 5.01f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	
	charIndex = GLBitmapFont_indexAtPositionX(font, "cdd", 3, 1.0f, 7.865f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "cdd", 3, 1.0f, 7.885f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "cdd", 3, 1.0f, 47.365f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "cdd", 3, 1.0f, 47.385f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "cdd", 3, 1.0f, 110.74f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 2, "Expected 2 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "cdd", 3, 1.0f, 110.76f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 2, "Expected 2 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "\tcdd\x7F", 5, 1.0f, 110.74f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 3, "Expected 3 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "\tcdd\x7F", 5, 1.0f, 110.76f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 3, "Expected 3 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	font->dispose(font);
	...
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 3.99f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 4.01f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 8.24f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 8.26f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 9.49f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 2, "Expected 2 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 9.51f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 2, "Expected 2 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "abc", 3, 1.0f, 11.5f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 2, "Expected 2 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	
	charIndex = GLBitmapFont_indexAtPositionX(font, "ba", 2, 1.0f, 0.24f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "ba", 2, 1.0f, 0.26f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "ba", 2, 1.0f, 4.49f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	...
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "ba", 2, 1.0f, 9.5f, 0.0f, NULL);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	
	charIndex = GLBitmapFont_indexAtPositionX(font, "add", 3, 1.0f, 3.865f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "add", 3, 1.0f, 3.885f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 0, "Expected 0 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "add", 3, 1.0f, 23.5525f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "add", 3, 1.0f, 23.5725f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 1, "Expected 1 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "add", 3, 1.0f, 55.3025f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 2, "Expected 2 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "add", 3, 1.0f, 55.3225f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 2, "Expected 2 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	charIndex = GLBitmapFont_indexAtPositionX(font, "\tadd\x7F", 5, 1.0f, 55.3025f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 3, "Expected 3 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(leadingEdge, "Expected true but got false");
	charIndex = GLBitmapFont_indexAtPositionX(font, "\tadd\x7F", 5, 1.0f, 55.3225f, 0.0f, &leadingEdge);
	TestCase_assert(charIndex == 3, "Expected 3 but got " SIZE_T_FORMAT, charIndex);
	TestCase_assert(!leadingEdge, "Expected false but got true");
	font->dispose(font);
}
